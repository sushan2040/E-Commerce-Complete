...
public class JwtService {
   ...
   // @Value("${security.jwt.expiration-time}")
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return buildToken(extraClaims, userDetails, (Long.valueOf(environment.getProperty("security.jwt.expiration-time") )*60*1000));
    }

    public long getExpirationTime() {
        return (Long.valueOf(environment.getProperty("security.jwt.expiration-time")) *60*1000);
    }
