...
public static final org.slf4j.Logger logger = LoggerFactory.getLogger(EcommerceApplication.class);
	...
	public static void main(String[] args) {
		new SpringApplicationBuilder(EcommerceApplication.class).sources(EcommerceApplication.class)
				.properties(getProperties()).run(args);


		logger.info(":: MAHAHMIS-PG ::        (v1.1.RELEASE)");
		logger.info(":: JAVA version       ::        (" + System.getProperty("java.version") + ")");		
		System.out.println(" ****************************************************  ");
		logger.info(" **********************ApplicationConfiguration Init...  ");
		logger.info(" ********************** MAHAHMIS-PG-Administrator API   ");
		logger.info(" ****************************************************  ");
				}
