...
public class LocationLevel3Controller {
    ...
    @PostMapping("/save")
    public ResponseEntity<Map<String, String>> savelevel3(
    ...
    public ResponseEntity<List<Level3MasterBean>> fetchAlllevel3s() {
    ...
    public ResponseEntity<PaginationResponse<Level3MasterBean>> getAlllevel3sPagination(
    ...
    public ResponseEntity<Map<String, String>> deletelevel3(@PathVariable("id") Integer level3Id) {
    ...
    public ResponseEntity<Level3MasterBean> getlevel3ById(@PathVariable("id") Integer level3Id) {
    ...
    public ResponseEntity<List<Level3MasterBean>> getLocationLevel3ByLevel1(@PathVariable("id") Integer parentId) {
