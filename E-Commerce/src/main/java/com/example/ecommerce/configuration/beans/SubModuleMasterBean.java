...
public class SubModuleMasterBean extends PaginationCommonBean implements Serializable{
	...
	public SubModuleMasterBean(Integer subModuleId, String subModuleName,String requestMapping, Integer parentId, String status,
			String icon
			) {
		super();
		this.subModuleId = subModuleId;
