...
public class Constants {
	...
	public static final String USER_NOT_SELLER="N";
	public static final String USER_STATUS_ACTIVE="Y";
	public static final String USER_STATUS_INACTIVE="N";
	public static final String USER_DELETED="Y";
	public static final String USER_NOT_DELETED="N";
	public static final String USER_SELLER="Y";
	...
	public static final String SELLER_USERTYPE="Vendor";
