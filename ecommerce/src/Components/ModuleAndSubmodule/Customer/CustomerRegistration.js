...
export default function CustomerRegistration() {
    ...
    function register() {
        ...
        api.post(CONSTANTS.BASE_URL + "/api-data/auth/register", obj, {
            headers: {
                        ...
                        <div className="card shadow p-4">
                            <div className="row" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                                ...
                                <div className="col-sm-8 form-floating mt-2">
                                    ...
                                    <input type="email" id="floatingEmail" ref={username} className="form-control" placeholder="Enter email" />
                                    <label for="floatingEmail" className="form-label form-floating">Enter email</label>
                                </div>
                                <div className="col-sm-8 form-floating mt-2">
                                    <input type="password" id="floatingPassword" ref={password} className="form-control" placeholder="Enter password" />
                                    <label for="floatingPassword" className="form-label form-floating">Enter password</label>
                                </div>
                                <div className="col-sm-8 form-floating mt-2">
                                    <input type="text" id="floatingPassword" ref={firstName} className="form-control" placeholder="Enter first name" />
                                    <label for="floatingPassword" className="form-label form-floating">Enter first name</label>
                                </div>
                                <div className="col-sm-8 form-floating mt-2">
                                    <input type="text" id="floatingPassword" ref={lastName} className="form-control" placeholder="Enter first name" />
                                    <label for="floatingPassword" className="form-label form-floating">Enter last name</label>
                                </div>
                                ...
                                <div className="col-sm-8 mt-2" style={{ backgroundColor: '#EEEEEE', borderRadius: '7rem', color: 'black', textDecoration: "underline" }}>
                                    <span>click to go on <NavLink to="/" style={{ textDecoration: "underline" }}>login page</NavLink></span>
                                </div>
                            </div>
                        </div>
                    </div>
